...
>
    ...
    <trix-editor x-ref="trix" input="x" class="prose max-w-none border-transparent focus:ring-transparent focus:border-transparent outline-none focus:z-10 px-0" style="min-height: 22em;" placeholder="{{ __('Begin writing your post…') }}"></trix-editor>
</div>
