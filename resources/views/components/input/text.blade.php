...
@else
    <div class="flex rounded">
        ...
        <input {{ $attributes->merge(['class' => 'flex-1 focus:ring-primary-500 focus:border-primary-500 text-sm leading-4 border-gray-300 rounded' . ($leadingAddOn ? ' rounded-l-none' : '')]) }}">
    </div>
@endif
