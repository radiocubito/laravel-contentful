    ...
    <form wire:submit.prevent="save">
        ...
        <div class="py-6">
            <div class="px-4 sm:px-6 lg:px-8">
                <h2 class="text-gray-500 text-sm leading-4 font-medium">{{ __('Manage page settings') }}</h2>
                        ...
                        <div class="p-4 border border-gray-200 rounded-md bg-gray-50">
                            <div class="divide-y divide-gray-200 -my-4 sm:-my-5">
                                ...
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <x-wordful::input.select id="status" wire:model="page.status" class="max-w-lg block w-full">
                        ...
                        <div x-show="on" class="mt-4 p-4 border border-gray-200 rounded-md bg-gray-50">
                            <div class="divide-y divide-gray-200 -my-4 sm:-my-5">
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <x-wordful::input.textarea id="custom_excerpt" class="block w-full" wire:model.defer="page.custom_excerpt" :placeholder="$page->excerpt" rows="5" />
                        ...
                        <div x-show="on" class="mt-4 p-4 border border-gray-200 rounded-md bg-gray-50">
                            <div class="divide-y divide-gray-200 -my-4 sm:-my-5">
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <x-wordful::input.text id="meta_title" type="text" class="block w-full" wire:model.defer="page.meta.meta_title" :placeholder="$page->title" />
                                ...
                                <div class="py-4 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4">
                                    ...
                                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                                        <x-wordful::input.textarea id="meta_description" class="block w-full" wire:model.defer="page.meta.meta_description" :placeholder="$page->excerpt" rows="4" />
