            ...
            <x-slot name="actions">
                <div class="flex items-center divide-x">
                    <div class="flex items-center space-x-2">
                        <x-wordful::button color="transparent" href="{{ route('wordful.pages.show', $page) }}">
                            {{ __('Cancel') }}
                        </x-wordful::Cancel>
            ...
            <div class="space-y-8">
                <x-wordful::input.section>
                    ...
                    <x-wordful::input.inline-group>
                        ...
                        <div class="max-w-lg">
                            <x-wordful::input.text id="slug" type="text" class="block w-full" leading-add-on="{{ request()->getHost() }}/" wire:model.defer="page.slug" />
                            <x-wordful::input.error for="page.slug" class="mt-2"/>
                        </div>
                    </x-wordful::input.inline-group>
                    ...
                    <x-wordful::input.inline-group>
                        ...
                        <x-wordful::input.select id="status" wire:model="page.status" class="max-w-xs block w-full">
                        ...
                        <x-wordful::input.error for="page.status" class="mt-2"/>
                    </x-wordful::input.inline-group>
                ...
                <x-wordful::input.section wire:model="customExcerptEnabled" expandable>
                    <x-slot name="heading">
                        <div class="flex flex-col">
                            <h2 id="custom-excerpt-label"
                                    ...
                                    class="text-sm font-medium text-gray-900 cursor-default">
                    ...
                    <x-wordful::input.inline-group>
                        ...
                        <x-wordful::input.textarea id="excerpt" class="block w-full max-w-lg" wire:model.defer="page.custom_excerpt" :placeholder="$page->excerpt" rows="5" />

                        <x-wordful::input.error for="page.custom_excerpt" class="mt-2"/>
                    </x-wordful::input.inline-group>
                </x-wordful::input.section>
                ...
                <x-wordful::input.section wire:model="customMetaDataEnabled" expandable>
                    ...
                    <x-wordful::input.inline-group>
                        ...
                        <x-wordful::input.text id="meta-title" type="text" class="block w-full max-w-lg sm:max-w-xs" wire:model.defer="page.meta.meta_title" :placeholder="$page->title" />
                        <x-wordful::input.error for="page.meta.meta_title" class="mt-2" />
                    </x-wordful::input.inline-group>
                    ...
                    <x-wordful::input.inline-group>
                        ...
                        <x-wordful::input.textarea id="meta-description" class="block w-full max-w-lg" wire:model.defer="page.meta.meta_description" :placeholder="$page->excerpt" rows="4" />

                        <x-wordful::input.error for="page.meta.meta_description" class="mt-2"/>
                    </x-wordful::input.inline-group>
                </x-wordful::input.section>
