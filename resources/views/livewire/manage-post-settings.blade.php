    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <form wire:submit.prevent="save">
            <div class="pb-5 border-b border-gray-200">
                ...
                <p class="mt-2 max-w-4xl text-sm font-medium text-gray-500">{{ __('Manage post settings') }}</p>
            </div>
            <div class="py-6">
                <div>
                ...
                <div class="pt-6">
                    ...
                    <div class="mt-2">
                        {{ __('Or,') }} <x-wordful::link href="{{ route('wordful.posts.show', $post) }}">{{ __('discard my changes') }}</x-wordful::link>
                    </div>
                </div>
            </div>
        </form>
